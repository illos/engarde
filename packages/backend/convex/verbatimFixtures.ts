...
export const KOBOLD_SIGNIFER = {
  ...
  statsJson:
    '{"staminaMax":15,"staminaResidue":null,"characteristics":{"might":0,"agility":1,"reason":0,"intuition":0,"presence":2},"immunities":[],"weaknesses":[],"potencies":null,"recoveriesMax":null,"freeStrike":1,"organization":"Horde","withCaptain":null,"withCaptainBenefit":null,"unparsedRows":[]}',
} as const;
...
export const WAR_DOG_AEROCITE = {
  ...
  statsJson:
    '{"staminaMax":50,"staminaResidue":null,"characteristics":{"might":0,"agility":4,"reason":1,"intuition":3,"presence":1},"immunities":[],"weaknesses":[],"potencies":null,"recoveriesMax":null,"freeStrike":3,"organization":"Horde","withCaptain":null,"withCaptainBenefit":null,"unparsedRows":[]}',
} as const;

/**
 * Source en/books/monsters/md/monster/goblin/statblock/goblin-monarch.md,
 * artifact mcdm.monsters.v1/monster.goblin.statblock/goblin-monarch,
 * text sha256 b024ce6ae974…. Carries the Meat Shield triggered
 * action, and the three printed Villain Actions (What Are You Waiting
 * For? / Focus Fire / Kill!) — the action-economy host E2E fixture
 * [R-0029..R-0032].
 */
export const GOBLIN_MONARCH = {
  artifactId: 'mcdm.monsters.v1/monster.goblin.statblock/goblin-monarch',
  slug: 'goblin-monarch',
  textSha256: 'b024ce6ae9746cc06c6d71b962d6c308f017571d26a01bf8e67f48107cdb8f72',
  ...
  statsJson:
    '{"staminaMax":80,"staminaResidue":null,"characteristics":{"might":0,"agility":3,"reason":1,"intuition":0,"presence":3},"immunities":[],"weaknesses":[],"potencies":null,"recoveriesMax":null,"freeStrike":4,"organization":"Leader","withCaptain":null,"withCaptainBenefit":null,"unparsedRows":[]}',
} as const;
