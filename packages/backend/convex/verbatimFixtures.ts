...
export const KOBOLD_SIGNIFER = {
  ...
  statsJson:
    '{"staminaMax":15,"characteristics":{"might":0,"agility":1,"reason":0,"intuition":0,"presence":2},"immunities":[],"weaknesses":[],"potencies":null,"recoveriesMax":null,"freeStrike":1,"organization":"Horde","withCaptain":null,"withCaptainBenefit":null,"unparsedRows":[]}',
} as const;
...
export const WAR_DOG_AEROCITE = {
  ...
  statsJson:
    '{"staminaMax":50,"characteristics":{"might":0,"agility":4,"reason":1,"intuition":3,"presence":1},"immunities":[],"weaknesses":[],"potencies":null,"recoveriesMax":null,"freeStrike":3,"organization":"Horde","withCaptain":null,"withCaptainBenefit":null,"unparsedRows":[]}',
} as const;
...
export const GOBLIN_MONARCH = {
  ...
  statsJson:
    '{"staminaMax":80,"characteristics":{"might":0,"agility":3,"reason":1,"intuition":0,"presence":3},"immunities":[],"weaknesses":[],"potencies":null,"recoveriesMax":null,"freeStrike":4,"organization":"Leader","withCaptain":null,"withCaptainBenefit":null,"unparsedRows":[]}',
} as const;
