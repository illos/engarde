...
export const KOBOLD_SIGNIFER = {
  ...
  statsJson:
    '{"staminaMax":15,"characteristics":{"might":0,"agility":1,"reason":0,"intuition":0,"presence":2},"immunities":[],"weaknesses":[],"potencies":null,"recoveriesMax":null,"organization":"Horde","withCaptain":null,"unparsedRows":[]}',
} as const;
...
export const WAR_DOG_AEROCITE = {
  ...
  statsJson:
    '{"staminaMax":50,"characteristics":{"might":0,"agility":4,"reason":1,"intuition":3,"presence":1},"immunities":[],"weaknesses":[],"potencies":null,"recoveriesMax":null,"organization":"Horde","withCaptain":null,"unparsedRows":[]}',
} as const;
