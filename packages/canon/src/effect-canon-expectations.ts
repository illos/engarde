...
/**
 * Channel-2 golden expectations for the 12 flat-resource Effect lines
 * [R-0017..R-0022] — the `spend-recovery-exact` (6), `regains-stamina-flat`
 * (2), `temporary-stamina-flat` (1), and `area-difficult-terrain` (3) closed
 * templates. Generated by an INDEPENDENT raw physical-line scanner over the
 * pinned bundles (own frontmatter stripping, marker counting, and header-cell
 * extraction — the production grammar was never imported or run), calibrated
 * byte-identically against four pre-existing entries, then frozen
 * (2026-08-25).
 */
export interface FlatResourceCanonExpectation {
  artifactId: string;
  effectOrdinal: number;
  sourcePath: string;
  sourceSpan: { byteStart: number; byteEnd: number };
  ...
  resolution: Extract<
    EffectResolution,
    { kind: 'spend-recovery' | 'regain-stamina' | 'temporary-stamina' | 'terrain-fact' }
  >;
}

export const FLAT_RESOURCE_CANON_EXPECTATIONS: FlatResourceCanonExpectation[] = [
  {
    artifactId: 'mcdm.heroes.v1/feature.ability.conduit.level-1/drain',
    effectOrdinal: 1,
    sourcePath: 'en/books/heroes/md/feature/ability/conduit/level-1/drain.md',
    sourceSpan: { byteStart: 643, byteEnd: 803 },
    sourceText:
      'You or one ally within [distance](scc.v1:mcdm.heroes.v1/rule.combat/distance) can spend a [Recovery](scc.v1:mcdm.heroes.v1/rule.health/recoveries).',
    targetsText: 'One creature',
    resolution: {
      kind: 'spend-recovery',
      subjectText: 'You or one ally within distance',
      singular: true,
    },
  },
  {
    ...
    effectOrdinal: 1,
    sourcePath: 'en/books/heroes/md/feature/ability/conduit/level-1/healing-grace.md',
    sourceSpan: { byteStart: 354, byteEnd: 447 },
    sourceText: 'The target can spend a [Recovery](scc.v1:mcdm.heroes.v1/rule.health/recoveries).',
    targetsText: 'Self or one ally',
    resolution: { kind: 'spend-recovery', subjectText: 'The target', singular: true },
  },
  {
    artifactId: 'mcdm.heroes.v1/feature.ability.conduit.level-3/words-of-wrath-and-grace',
    effectOrdinal: 1,
    sourcePath: 'en/books/heroes/md/feature/ability/conduit/level-3/words-of-wrath-and-grace.md',
    sourceSpan: { byteStart: 592, byteEnd: 696 },
    sourceText:
      'Each ally in the area can spend a [Recovery](scc.v1:mcdm.heroes.v1/rule.health/recoveries).',
    targetsText: 'Each enemy in the area',
    resolution: { kind: 'spend-recovery', subjectText: 'Each ally in the area', singular: false },
  },
  {
    artifactId: 'mcdm.heroes.v1/feature.ability.elementalist.level-1/breath-of-dawn-remembered',
    effectOrdinal: 1,
    sourcePath:
      'en/books/heroes/md/feature/ability/elementalist/level-1/breath-of-dawn-remembered.md',
    sourceSpan: { byteStart: 513, byteEnd: 606 },
    sourceText: 'The target can spend a [Recovery](scc.v1:mcdm.heroes.v1/rule.health/recoveries).',
    targetsText: 'Self or one ally',
    resolution: { kind: 'spend-recovery', subjectText: 'The target', singular: true },
  },
  {
    artifactId: 'mcdm.heroes.v1/feature.ability.fury.level-5/my-turn',
    effectOrdinal: 1,
    sourcePath: 'en/books/heroes/md/feature/ability/fury/level-5/my-turn.md',
    sourceSpan: { byteStart: 891, byteEnd: 977 },
    sourceText: 'You can spend a [Recovery](scc.v1:mcdm.heroes.v1/rule.health/recoveries).',
    targetsText: 'The triggering creature',
    resolution: { kind: 'spend-recovery', subjectText: 'You', singular: true },
  },
  {
    artifactId: 'mcdm.heroes.v1/feature.ability.tactician.level-2/ive-got-your-back',
    effectOrdinal: 1,
    sourcePath: 'en/books/heroes/md/feature/ability/tactician/level-2/ive-got-your-back.md',
    sourceSpan: { byteStart: 918, byteEnd: 1078 },
    sourceText:
      'One ally [adjacent](scc.v1:mcdm.heroes.v1/rule.combat/adjacent) to the target can spend a [Recovery](scc.v1:mcdm.heroes.v1/rule.health/recoveries).',
    targetsText: 'One creature',
    resolution: {
      kind: 'spend-recovery',
      subjectText: 'One ally adjacent to the target',
      singular: true,
    },
  },
  {
    artifactId: 'mcdm.monsters.v1/monster.human.statblock/human-death-acolyte',
    effectOrdinal: 1,
    sourcePath: 'en/books/monsters/md/monster/human/statblock/human-death-acolyte.md',
    sourceSpan: { byteStart: 1239, byteEnd: 1347 },
    sourceText:
      'One creature within 5 squares regains 1 [Stamina](scc.v1:mcdm.heroes.v1/rule.health/stamina).',
    targetsText: 'One creature or object per minion',
    resolution: {
      kind: 'regain-stamina',
      amount: 1,
      subjectText: 'One creature within 5 squares',
      singular: true,
    },
  },
  {
    ...
    effectOrdinal: 2,
    sourcePath: 'en/books/monsters/md/monster/kobold/statblock/kobold-signifer.md',
    sourceSpan: { byteStart: 1650, byteEnd: 1740 },
    sourceText: 'Each target regains 5 [Stamina](scc.v1:mcdm.heroes.v1/rule.health/stamina).',
    targetsText: 'Each ally in the area',
    resolution: { kind: 'regain-stamina', amount: 5, subjectText: 'Each target', singular: false },
  },
  {
    artifactId: 'mcdm.heroes.v1/feature.ability.fury.level-3/steelbreaker',
    effectOrdinal: 1,
    sourcePath: 'en/books/heroes/md/feature/ability/fury/level-3/steelbreaker.md',
    sourceSpan: { byteStart: 180, byteEnd: 278 },
    sourceText:
      'You gain 20 [temporary Stamina](scc.v1:mcdm.heroes.v1/rule.health/temporary-stamina).',
    targetsText: 'Self',
    resolution: { kind: 'temporary-stamina', amount: 20, subjectText: 'You', singular: true },
  },
  {
    artifactId: 'mcdm.monsters.v1/dynamic-terrain.mechanisms/pillar',
    effectOrdinal: 2,
    sourcePath: 'en/books/monsters/md/dynamic-terrain/mechanisms/pillar.md',
    sourceSpan: { byteStart: 1558, byteEnd: 1655 },
    sourceText:
  ...
  {
    artifactId: 'mcdm.monsters.v1/monster.orc.statblock/orc-terranova',
    effectOrdinal: 2,
    sourcePath: 'en/books/monsters/md/monster/orc/statblock/orc-terranova.md',
    sourceSpan: { byteStart: 2025, byteEnd: 2122 },
    sourceText:
      'The area is [difficult terrain](scc.v1:mcdm.heroes.v1/movement/difficult-terrain).',
    targetsText: 'Each enemy and object in the area',
    resolution: { kind: 'terrain-fact', terrain: 'difficult' },
  },
  {
    ...
    effectOrdinal: 1,
    sourcePath: 'en/books/monsters/md/monster/war-dog/3rd-echelon/statblock/war-dog-aerocite.md',
    sourceSpan: { byteStart: 2072, byteEnd: 2169 },
    sourceText:
      'The area is [difficult terrain](scc.v1:mcdm.heroes.v1/movement/difficult-terrain).',
    targetsText: 'Each creature or object in the area',
    resolution: { kind: 'terrain-fact', terrain: 'difficult' },
  },
];
