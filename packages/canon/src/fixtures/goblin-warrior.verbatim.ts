...
export const GOBLIN_WARRIOR = {
  ...
  statsJson:
    '{"staminaMax":15,"characteristics":{"might":-2,"agility":2,"reason":0,"intuition":0,"presence":-1},"immunities":[],"weaknesses":[],"potencies":null,"recoveriesMax":null,"organization":"Horde","withCaptain":null,"unparsedRows":[]}',
} as const;
