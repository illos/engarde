...
export const GOBLIN_WARRIOR = {
  ...
  statsJson:
    '{"staminaMax":15,"staminaResidue":null,"characteristics":{"might":-2,"agility":2,"reason":0,"intuition":0,"presence":-1},"immunities":[],"weaknesses":[],"potencies":null,"recoveriesMax":null,"freeStrike":1,"organization":"Horde","withCaptain":null,"withCaptainBenefit":null,"unparsedRows":[]}',
} as const;
