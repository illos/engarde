...
export const SKITTERLING = {
  ...
  statsJson:
    '{"staminaMax":3,"characteristics":{"might":-5,"agility":2,"reason":-4,"intuition":0,"presence":-2},"immunities":[],"weaknesses":[],"potencies":null,"recoveriesMax":null,"organization":"Minion","withCaptain":"+3 bonus to speed","unparsedRows":[]}',
} as const;
