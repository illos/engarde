...
export const SKITTERLING = {
  ...
  statsJson:
    '{"staminaMax":3,"staminaResidue":null,"characteristics":{"might":-5,"agility":2,"reason":-4,"intuition":0,"presence":-2},"immunities":[],"weaknesses":[],"potencies":null,"recoveriesMax":null,"freeStrike":1,"organization":"Minion","withCaptain":"+3 bonus to speed","withCaptainBenefit":{"kind":"directive","template":"speed","amount":3,"sourceText":"+3 bonus to speed"},"unparsedRows":[]}',
} as const;
