...
export const GOBLIN_SPINECLEAVER = {
  ...
  statsJson:
    '{"staminaMax":5,"characteristics":{"might":2,"agility":0,"reason":0,"intuition":0,"presence":-1},"immunities":[],"weaknesses":[],"potencies":null,"recoveriesMax":null,"organization":"Minion","withCaptain":"+1 damage bonus to strikes","unparsedRows":[]}',
} as const;
